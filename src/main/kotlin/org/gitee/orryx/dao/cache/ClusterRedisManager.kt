...
class ClusterRedisManager : ISyncCacheManager {
    ...
    override fun getPlayerProfile(player: UUID): CompletableFuture<PlayerProfilePO> {
        ...
        return readThrough(
            ...
            ttl = RedisManager.SECOND_12_HOURS,
    ...
    override fun getPlayerSkill(player: UUID, id: Int, job: String, skill: String): CompletableFuture<PlayerSkillPO?> {
        ...
        return readThrough(
            ...
            ttl = RedisManager.SECOND_6_HOURS,
    ...
    private fun <T> readThrough(
        ...
        return redisReadFuture(
            useCommands = { consumer: (RedisClusterAsyncCommands<String, String>) -> Unit -> api.useAsyncCommands(consumer) },
    ...
    private fun redisCommand(
        command: (RedisClusterAsyncCommands<String, String>) -> java.util.concurrent.CompletionStage<*>,
