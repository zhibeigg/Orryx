...
object PlayerBucketFillTrigger: AbstractEventTrigger<PlayerBucketFillEvent>() {
    ...
    override fun onJoin(event: PlayerBucketFillEvent, map: Map<String, Any?>): ProxyCommandSender {
        return adaptPlayer(event.player)
    }

    override fun onCheck(pipeTask: IPipeTask, event: PlayerBucketFillEvent, map: Map<String, Any?>): Boolean {
