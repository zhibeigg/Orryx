...
object OrryxPlayerJobChangePreTrigger: AbstractPropertyEventTrigger<OrryxPlayerJobChangeEvents.Pre>("Orryx Player Job Change Pre") {
    ...
    override fun onCheck(pipeTask: IPipeTask, event: OrryxPlayerJobChangeEvents.Pre, map: Map<String, Any?>): Boolean {
        return pipeTask.scriptContext?.sender?.origin == event.player
    }

    override fun read(instance: OrryxPlayerJobChangeEvents.Pre, key: String): OpenResult {
        return when (key) {
    ...
    override fun write(instance: OrryxPlayerJobChangeEvents.Pre, key: String, value: Any?): OpenResult {
