...
@Plugin("ArcartX")
object ArcartXEntityJoinTrigger: AbstractPropertyEventTrigger<ClientEntityJoinEvent>("ArcartX Entity Join") {
    ...
    override val clazz
        get() = ClientEntityJoinEvent::class.java

    override fun onJoin(event: ClientEntityJoinEvent, map: Map<String, Any?>): ProxyCommandSender {
        return adaptPlayer(event.player)
    }

    override fun onCheck(pipeTask: IPipeTask, event: ClientEntityJoinEvent, map: Map<String, Any?>): Boolean {
        return (pipeTask.scriptContext?.sender?.origin == event.player)
    }

    override fun read(instance: ClientEntityJoinEvent, key: String): OpenResult {
        return when(key) {
    ...
    override fun write(instance: ClientEntityJoinEvent, key: String, value: Any?): OpenResult {
