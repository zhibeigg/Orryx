...
@Plugin("DungeonPlus")
object DungeonLeaveTrigger: AbstractPipeEventTrigger<DungeonEvent>() {

    override val event = "Dungeon Leave"
    ...
    override fun onCheck(pipeTask: IPipeTask, event: DungeonEvent, map: Map<String, Any?>): Boolean {
        val e = event.event
        return e is DungeonLeaveEvent && (pipeTask.scriptContext?.sender?.origin in e.dungeon.team.getPlayers(PlayerStateType.ONLINE))
    }
