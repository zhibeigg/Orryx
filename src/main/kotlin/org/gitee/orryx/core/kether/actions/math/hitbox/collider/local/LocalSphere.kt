...
open class LocalSphere<T : ITargetLocation<*>>(
    ...
    private val fastBounds = AABBPlus<T>(Vector3d(radius, radius, radius), globalCenter)
    ...
    override var radius: Double = radius
        set(value) {
            field = value
            fastBounds.halfExtents.set(value, value, value)
        }
    ...
    protected fun setCenterDirty() { dirty = true }
