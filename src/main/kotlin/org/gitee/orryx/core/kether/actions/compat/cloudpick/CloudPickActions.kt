package org.gitee.orryx.core.kether.actions.compat.cloudpick
...
import yslelf.cloudpick.bukkit.api.FashionAPI
import yslelf.cloudpick.bukkit.api.PacketSender
import yslelf.cloudpick.bukkit.api.SlotAPI
import yslelf.cloudpick.bukkit.api.event.PlayerFashionUpdateEvent
...
object CloudPickActions {
    ...
    @Ghost
    @SubscribeEvent
    private fun armourers(e: PlayerFashionUpdateEvent) {
        val list = fashionMap[e.player.uniqueId]
    ...
    private fun cloudPick() = scriptParser(
        Action.new("CloudPick附属语句", "设置临时时装", "cloudpick", true)
            .description("设置临时时装")
        ...
        Action.new("CloudPick附属语句", "清除临时时装", "cloudpick", true)
            .description("清除临时时装")
            .addEntry("armourers标识符", Type.SYMBOL, false, head = "armourers")
            .addEntry("清除标识符", Type.SYMBOL, false, head = "clear")
            .addEntry("时装名", Type.STRING, true, "ALL")
            .addContainerEntry(optional = true, default = "@self"),
        Action.new("CloudPick附属语句", "更新时装", "cloudpick", true)
            .description("更新时装")
            .addEntry("armourers标识符", Type.SYMBOL, false, head = "armourers")
            .addEntry("更新标识符", Type.SYMBOL, false, head = "update")
            .addContainerEntry(optional = true, default = "@self"),
        Action.new("CloudPick附属语句", "发送暴雪粒子", "cloudpick", true)
            .description("发送暴雪粒子")
        ...
        Action.new("CloudPick附属语句", "移除暴雪粒子", "cloudpick", true)
            .description("移除暴雪粒子")
            .addEntry("粒子标识符", Type.SYMBOL, false, head = "effect/particle")
            .addEntry("移除标识符", Type.SYMBOL, false, head = "remove")
            .addEntry("粒子ID", Type.STRING, false)
            .addContainerEntry("可视玩家", true, "@server"),
        Action.new("CloudPick附属语句", "清除暴雪粒子", "cloudpick", true)
            .description("清除暴雪粒子")
            .addEntry("粒子标识符", Type.SYMBOL, false, head = "effect/particle")
            .addEntry("清除标识符", Type.SYMBOL, false, head = "clear")
            .addContainerEntry("可视玩家", true, "@self"),
        Action.new("CloudPick附属语句", "设置玩家动作", "cloudpick", true)
            .description("设置玩家动作")
        ...
        Action.new("CloudPick附属语句", "移除玩家动作", "cloudpick", true)
            .description("移除玩家动作")
            .addEntry("动作标识符", Type.SYMBOL, false, head = "animation/ani")
            .addEntry("移除标识符", Type.SYMBOL, false, head = "remove")
            .addEntry("玩家标识符", Type.SYMBOL, false, head = "player")
            .addContainerEntry("移除玩家", true, "@self"),
        Action.new("CloudPick附属语句", "设置实体动作", "cloudpick", true)
            .description("设置实体动作")
            .addEntry("动作标识符", Type.SYMBOL, false, head = "animation/ani")
            .addEntry("设置标识符", Type.SYMBOL, false, head = "set/to")
            ...
            .addContainerEntry("可视玩家", true, "@server", "viewers"),
        Action.new("CloudPick附属语句", "移除实体动作", "cloudpick", true)
            .description("移除实体动作")
            .addEntry("动作标识符", Type.SYMBOL, false, head = "animation/ani")
            .addEntry("移除标识符", Type.SYMBOL, false, head = "remove")
            .addEntry("实体标识符", Type.SYMBOL, false, head = "entity")
            ...
            .addContainerEntry("设置实体", false)
            .addContainerEntry("可视玩家", true, "@server", "viewers"),
        Action.new("CloudPick附属语句", "设置玩家手持物品动作", "cloudpick", true)
        ...
        Action.new("CloudPick附属语句", "设置方块动作", "cloudpick", true)
            .description("设置方块动作")
            .addEntry("动作标识符", Type.SYMBOL, false, head = "animation/ani")
            .addEntry("设置标识符", Type.SYMBOL, false, head = "set")
        ...
        Action.new("CloudPick附属语句", "播放音乐", "cloudpick", true)
            .description("播放音乐")
        ...
        Action.new("CloudPick附属语句", "停止播放音乐", "cloudpick", true)
            .description("停止播放音乐")
            .addEntry("音乐唯一ID", Type.STRING, false)
            .addContainerEntry("可听玩家", true, "@self"),
        Action.new("CloudPick附属语句", "运行云拾GUI方法", "cloudpick", true)
            .description("运行云拾GUI方法")
        ...
        Action.new("CloudPick附属语句", "运行云拾动作控制器方法", "cloudpick", true)
            .description("运行云拾动作控制器方法")
            .addEntry("方法标识符", Type.SYMBOL, false, head = "function/func")
            .addEntry("动作标识符", Type.SYMBOL, false, head = "animation/ani")
            .addEntry("方法语句", Type.STRING, false)
            .addContainerEntry("执行的玩家", true, "@self"),
        Action.new("CloudPick附属语句", "运行云拾headTag方法", "cloudpick", true)
            .description("运行云拾headTag方法")
            .addEntry("方法标识符", Type.SYMBOL, false, head = "function/func")
            .addEntry("tag标识符", Type.SYMBOL, false, head = "headtag/tag")
            .addEntry("执行实体UUID", Type.STRING, false)
            .addEntry("方法语句", Type.STRING, false)
            .addContainerEntry("客户端参与执行的玩家", true, "@self"),
        Action.new("CloudPick附属语句", "打开GUI", "cloudpick", true)
            .description("打开云拾Gui")
            .addEntry("gui标识符", Type.SYMBOL, false, head = "gui")
            .addEntry("gui名字", Type.STRING, false)
            .addContainerEntry("打开GUI的玩家", true, "@self"),
        Action.new("CloudPick附属语句", "打开HUD", "cloudpick", true)
            .description("打开云拾HUD")
            .addEntry("hud标识符", Type.SYMBOL, false, head = "hud")
            .addEntry("hud名字", Type.STRING, false)
            .addContainerEntry("打开HUD的玩家", true, "@self"),
        Action.new("CloudPick附属语句", "发送同步papi数据", "cloudpick", true)
            ...
            .example("cp papi send a,b,c they \"@self\""),
        Action.new("CloudPick附属语句", "删除papi数据", "cloudpick", true)
            ...
            .example("cp papi delete a,b,c false they \"@self\""),
        Action.new("CloudPick附属语句", "设置headTag", "cloudpick", true)
            ...
            .addContainerEntry("可视玩家", true, "@self", "viewers"),
        Action.new("CloudPick附属语句", "移除headTag", "cloudpick", true)
            .description("移除实体的headTag")
            .addEntry("headTag标识符", Type.SYMBOL, false, head = "headtag/tag")
            .addEntry("移除标识符", Type.SYMBOL, false, head = "remove")
            .addEntry("移除的实体uuid", Type.STRING, false)
            .addContainerEntry("可视玩家", true, "@self", "viewers"),
        Action.new("CloudPick附属语句", "设置实体模型", "cloudpick", true)
            .description("设置实体模型")
            ...
            .addEntry("匹配名", Type.STRING, false)
            .addContainerEntry("可视玩家", true, "@self", "viewers"),
        Action.new("CloudPick附属语句", "移除实体模型", "cloudpick", true)
            .description("移除实体模型")
            .addEntry("模型标识符", Type.SYMBOL, false, head = "model")
            .addEntry("移除标识符", Type.SYMBOL, false, head = "remove")
            .addEntry("移除的实体uuid", Type.STRING, false)
            .addContainerEntry("可视玩家", true, "@self", "viewers"),
        Action.new("CloudPick附属语句", "虚拟绑定实体位置", "cloudpick", true)
            ...
            .addContainerEntry("可视玩家", true, "@self", "viewers"),
        Action.new("CloudPick附属语句", "实体模型特效绑定", "cloudpick", true)
        ...
        Action.new("CloudPick附属语句", "实体模型特效移除", "cloudpick", true)
            .description("实体模型特效移除")
            .addEntry("实体模型标识符", Type.SYMBOL, false, head = "modelEffect")
            .addEntry("移除标识符", Type.SYMBOL, false, head = "remove")
            .addEntry("实体唯一ID", Type.STRING, false)
            .addContainerEntry("绑定的实体", true, "@self"),
        Action.new("CloudPick附属语句", "隐藏玩家手持武器", "cloudpick", true)
        ...
        Action.new("CloudPick附属语句", "获取槽位内物品", "cloudpick", true)
            .description("获取槽位内物品")
                ...
                run(timeout).long { timeout ->
                    containerOrSelf(container) { container ->
                        container.forEachInstance<PlayerTarget> { player ->
                            fashionMap.getOrPut(player.uniqueId) { mutableListOf() }.add(armourers)
                            FashionAPI.updatePlayerFashion(player.getSource())
                            SimpleTimeoutTask.createSimpleTask(timeout) {
                                if (fashionMap.containsKey(player.uniqueId)) {
                                    fashionMap[player.uniqueId]!!.remove(armourers)
                                    FashionAPI.updatePlayerFashion(player.getSource())
                                }
                            }
                        }
        ...
        return actionNow {
            if (container1 == null) {
                ...
                containerOrSelf(container1) { container ->
                    container.forEachInstance<PlayerTarget> { player ->
                        if (fashionMap.containsKey(player.uniqueId)) {
                            fashionMap[player.uniqueId]!!.clear()
                            FashionAPI.updatePlayerFashion(player.getSource())
                        }
                    }
                }
    ...
    private fun setAnimation(reader: QuestReader): ScriptAction<Any?> {
        return when (reader.expects("player", "entity", "item", "block")) {
            ...
            else -> error("云拾set animation类型错误")
        }
    }
    ...
    private fun removeAnimation(reader: QuestReader): ScriptAction<Any?> {
        return when (reader.expects("player", "entity")) {
            ...
            else -> error("云拾remove animation类型错误")
        }
    }
    ...
    private fun setItemAnimation(reader: QuestReader): ScriptAction<Any?> {
        ...
        return actionNow {
            run(animation).str { animation ->
                run(speed).float { speed ->
                    containerOrSelf(entities) { entities ->
                        entities.forEachInstance<ITargetEntity<LivingEntity>> { entity ->
                            PacketSender.setEntityModelItemAnimation(
                                entity.getSource(),
                                animation,
                                speed
                            )
    ...
    private fun sendAnimationFunction(reader: QuestReader): ScriptAction<Any?> {
        ...
        return actionNow {
            run(function).str { function ->
                containerOrSelf(players) {
                    it.forEachInstance<PlayerTarget> { player ->
                        PacketSender.runPlayerAnimationControllerFunction(
                            player.getSource(),
                            function
                        )
                    }
