#!/usr/bin/env python3
"""Thin launcher for the orchestrator component of orryx-creation-suite."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the Orryx orchestrator contract pipeline.")
